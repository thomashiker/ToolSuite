...
namespace Cyotek.Windows.Forms
{
  ...
  public class ColorEditorManager : Component, IColorEditor
  {
    ...
    private static readonly object _eventColorEditorChanged = new object();
        private static readonly object _eventColorEditorSimpleChanged = new object();
    ...
    private ColorEditor _colorEditor;
        private ColorEditorSimple _colorEditorSimple;
    ...
    public event EventHandler ColorEditorChanged
    {
      ...
      remove { this.Events.RemoveHandler(_eventColorEditorChanged, value); }
        ...
        [Category("Property Changed")]
        public event EventHandler ColorEditorSimpleChanged
        {
            add { this.Events.AddHandler(_eventColorEditorSimpleChanged, value); }
            remove { this.Events.RemoveHandler(_eventColorEditorSimpleChanged, value); }
        }
    ...
    public virtual ColorEditor ColorEditor
    {
      ...
      set
      {
        ...
        /// <summary>
        /// Gets or sets the linked <see cref="ColorEditorSimple"/>.
        /// </summary>
        [Category("Behavior")]
        [DefaultValue(typeof(ColorEditorSimple), null)]
        public virtual ColorEditorSimple ColorEditorSimple
        {
            get { return _colorEditorSimple; }
            set
            {
                if (this.ColorEditorSimple != value)
                {
                    _colorEditorSimple = value;

                    this.OnColorEditorSimpleChanged(EventArgs.Empty);
                }
            }
        }
    ...
    protected virtual void OnColorEditorChanged(EventArgs e)
    {
      ...
      handler?.Invoke(this, e);
        ...
        /// <summary>
        /// Raises the <see cref="OnColorEditorSimpleChanged" /> event.
        /// </summary>
        /// <param name="e">The <see cref="EventArgs" /> instance containing the event data.</param>
        protected virtual void OnColorEditorSimpleChanged(EventArgs e)
        {
            EventHandler handler;

            if (this.ColorEditorSimple != null)
            {
                this.BindEvents(this.ColorEditorSimple);
            }

            handler = (EventHandler)this.Events[_eventColorEditorSimpleChanged];
      ...
      if (!this.LockUpdates)
      {
        try
        {
          ...
          this.SetColor(this.ColorEditor, sender);
                    this.SetColor(this.ColorEditorSimple, sender);
