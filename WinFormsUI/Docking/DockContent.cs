...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    {
        private VisualStudioToolStripExtender vsToolStripExtender = new VS2015ToolStripExtender();
        ...
        public virtual void UpdateStyle(object obj)
        {
        }
        ...
        public void ApplyTheme()
        {
            ...
            if (DockPanel != null)
            {
                ...
                EnableVSRenderer(DockPanel.Theme);
            }
        }
