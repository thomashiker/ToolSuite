namespace WeifenLuo.WinFormsUI.ThemeVS2015
{
    ...
    public abstract class VS2015ThemeBase : ThemeBase
    {
        ...
        public void RefreshImageService()
        {
            ((WeifenLuo.WinFormsUI.ThemeVS2012.ImageService)this.ImageService).UpdateImageServiceHelper();
        }
        ...
        {
            return GetType().Name;// System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.Name;
        }
    }
}
